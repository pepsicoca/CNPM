				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<div>
								<form action="xulyxoa2c.php" style=" display: contents" method="post">
									<input id="" name="id" class="" type="text" value="" placeholder="ID người dùng muốn xóa">
                                    <input id="btnkhachhang" class="btn btn-primary" type="submit" value="Xóa Thông Tin">
								</form>
							</div>
						</div>
					</div>
