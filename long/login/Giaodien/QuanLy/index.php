	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><span>Lý Lịch 2C</span></a>
						...
						<ul class="dashboard-list metro">
							<li>
								<a href="#">
									...
									<strong style="font-size:16px ; color:green">Giờ : <?php 
									date_default_timezone_set("asia/ho_chi_minh");
									echo date("h:i:sa"); ?></strong> </br>
							...
							<li>
								<a href="#">
									<i class="icon-arrow-up green"></i>                               
									<strong style="font-size:16px ; color:green">Ngày : <?php echo date("d-m-y"); ?></strong>
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							...
							<li class="blue">
								<a href="#">
									<img class="avatar" alt="Ây Zô Bờ Rô" src="img/avatar.jpg">
								</a>
								<strong>Name:</strong> <?php echo $_SESSION['login_user']; ?><br>
