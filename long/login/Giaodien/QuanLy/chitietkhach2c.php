				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<div>
								<form action="xulychitiet2c.php?id=<?php 
								if (!isset($var)) {
									echo 'Id Chưa có trong danh sách !!!';
								}else {
									echo $var;
								}
								?>" style=" display: contents" method="get">
									<input name="id" type="text" value="" placeholder="ID người muốn tìm kiếm">
                                    <input id="btnkhachhang" class="btn btn-primary" type="submit" value="Tìm">
								</form>
							</div>
						</div>
					</div>
