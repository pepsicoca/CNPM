...
$sql = "SELECT id ,HoTen,CMND,NgaySinh,QueQuan,NoiTamTru FROM form2c";
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon white user"></i><span class="break"></span>Danh Sách</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>
										...
										foreach ($data as $show) {
											...
											<td class="center">'.$show['HoTen'].'</td>
											<td class="center">'.$show['NgaySinh'].'</td>
											<td class="center">'.$show['CMND'].'</td>
											<td class="center">'.$show['NoiTamTru'].'</td>
											<td class="center">'.$show['QueQuan'].'</td>
											</tr>';
										}
										?>
								</tbody>
							...
							<div>
								<form action="suathongtin2c.php" style=" display: contents">
									<input id="btnkhachhang" class="btn btn-primary" type="submit"
										value="Sửa Thông Tin">
								</form>
								<form action="xoa2c.php" style=" display: contents">
									<input id="btnkhachhang" class="btn btn-primary" type="submit"
										value="Xóa Thông Tin">
								</form>
							</div>
