	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.php"><span>DỊCH VỤ THANH TOÁN</span></a>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="quanly.php">Nạp tiền</a></li>
			</ul>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Nạp tiền</h2>
						<div class="box-icon">
					...
					<div class="box-content">					
						<form method="post" action="xulynaptien.php">
                            <table>                        
								<tr> 
                                    <td>Số tiền nạp vào thẻ ngân hàng </td>
                                    <td> <input type="number" name="tien" min ="1">
                                    </td>
                                </tr>
                                <tr><td></td>
                                    <td colspan=2>
                                    <input id="btnChapNhan" type="submit" value="Đồng ý" name="sua">
                                    </td>
                                    
                                </tr>
                                <tr>
                                    <td colspan=2>
                                    <a href="thongtinthe.php">Quay lại</a>
                                    </td></tr>
                            </table>
